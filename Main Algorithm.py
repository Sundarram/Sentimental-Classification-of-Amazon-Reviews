...
if __name__ == '__main__':
    ...
    try:
        ...
        fname_vld_lbl = os.path.join(args.d, "dt%d.%s.lsa.SVC550C60g.lbl" % (args.id, "vld"))
        fname_tst_lbl = os.path.join(args.d, "dt%d.%s.lsa.SVC550C60g.lbl" % (args.id, "tst"))

        fname_vld_pred = os.path.join(args.d, "dt%d.%s.lsa.SVC550C60g.pred" % (args.id, "vld"))
        fname_tst_pred = os.path.join(args.d, "dt%d.%s.lsa.SVC550C60g.pred" % (args.id, "tst"))
